...
/**
 \func add(MList* &phead, int index, int data)
 Функция добавления элемента(data) в список на место index
*/
...
/**
\func del(MList* &phead, int index)
Функция удаления элемента с места index
*/
...
/**
\func get(MList* &phead, int index, int pdata)
Функция получения элемента из списка с места index в pdata
*/
